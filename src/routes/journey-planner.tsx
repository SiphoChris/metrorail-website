      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7">
          {showResults ? (
                ...
                upcomingTrains.map((train, i) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="group rounded-xl border border-white/10 bg-white/3 hover:border-blue-400/40 hover:bg-blue-500/5 transition-colors cursor-pointer p-5"
                    >
            ...
            <div className="h-full min-h-96 flex flex-col items-center justify-center text-center p-8 border-2 border-dashed border-white/8 rounded-xl bg-white/2">
