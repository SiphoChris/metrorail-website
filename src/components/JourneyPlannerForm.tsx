  ...
  return (
    <form onSubmit={handleSearch} className="space-y-6">
      <div className="relative space-y-4">
        ...
        <div className="absolute left-1.25 top-9 h-[calc(100%-36px-16px)] w-0.5 bg-white/10 z-0" />

        {/* From */}
        <div className="relative z-10 flex gap-4 items-start">
          <div className="shrink-0 mt-7.5 w-3 h-3 rounded-full border-2 border-blue-400 bg-[#151f33]" />
        ...
        {/* To */}
        <div className="relative z-10 flex gap-4 items-start">
          <div className="shrink-0 mt-7.5 w-3 h-3 rounded-full bg-blue-400" />
          <div className="flex-1">
